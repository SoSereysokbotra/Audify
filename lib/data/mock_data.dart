...
class MockData {
  static const List<SongModel> localSongs = [
    ...
    SongModel(
      ...
      artist: 'Khmer Music',
      coverUrl: 'https://i.ytimg.com/vi/N7tQqKupYDo/hq720.jpg?sqp=-oaymwE7CK4FEIIDSFryq4qpAy0IARUAAAAAGAElAADIQj0AgKJD8AEB-AH-CYAC0AWKAgwIABABGGUgYChaMA8=&rs=AOn4CLAkJgPxQ-cP-ZoRCRmhOjBwmf92kg',
    ...
    SongModel(
      ...
      coverUrl: 'https://i1.sndcdn.com/artworks-zXopyj5CzVwSC8RM-k7RKDg-t500x500.jpg',
    ...
    SongModel(
      ...
      title: '7 Years',
      artist: 'Lukas Graham',
      coverUrl: 'https://i.pinimg.com/236x/24/46/56/2446565338cee272c90cb038ac7794a3.jpg',
    ...
    SongModel(
      ...
      title: 'Impossible',
      artist: 'James Arthur',
      coverUrl: 'https://i.pinimg.com/736x/6a/41/dd/6a41dde6e5c372d7a7c38f2ce4574a52.jpg',
    ...
    SongModel(
      ...
      coverUrl: 'https://m.media-amazon.com/images/M/MV5BNmRkNTExYmYtNDQzMC00Mjk1LWJlMmMtZjYyMTcwMDAzYjYwXkEyXkFqcGc@._V1_.jpg',
    ...
    SongModel(
      ...
      title: 'It Will Rain',
      artist: 'Bruno Mars',
      coverUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJpEluJ0mJpvc4vcnS2PaEFdJL2rX5QPglvw&s',
    ...
    SongModel(
      ...
      artist: 'Bruno Mars',
      coverUrl: 'https://upload.wikimedia.org/wikipedia/en/6/62/Bruno-mars-when-i-was-your-man.jpg',
    ...
    SongModel(
      ...
      coverUrl: 'https://i.pinimg.com/1200x/3b/b3/5c/3bb35c263b47c3aa07f9f7ad64c3b5d7.jpg',
    ...
    SongModel(
      ...
      title: 'Cinnamon Girl',
      artist: 'Lana Del Rey',
      coverUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhcXuUdyMAWfV-evjy6G8iDNp2M0cgSfmXug&s',
    ...
    SongModel(
      ...
      title: "I'll Do It",
      artist: 'Heidi Montag',
      coverUrl: 'https://i.pinimg.com/736x/f4/7b/2e/f47b2e8ea4618a69120ce3de0c5d1071.jpg',
    ...
    SongModel(
      ...
      title: 'Men Arom',
      artist: 'Tena',
      coverUrl: 'https://i.scdn.co/image/ab67616d00001e02f101fe3679006543615d8003',
  ...
  static const List<RadioStationModel> popularRadio = [
    RadioStationModel(
      ...
      coverUrls: [
        'https://i.pinimg.com/736x/8e/53/30/8e5330de74b1edacc3f64937756e2bee.jpg0',
  ...
  static const List<AlbumModel> popularAlbums = [
    AlbumModel(
      ...
      coverUrl: 'https://i.pinimg.com/736x/e0/fa/cf/e0facfae91321fb09588ff1b49bed99c.jpg',
    ),
    AlbumModel(
      id: 'a2',
      title: 'Cosmic Dreams',
      artist: 'Space Surfer',
      coverUrl: 'https://i.pinimg.com/736x/90/e3/b1/90e3b1345e72db0845bb5ae2064152b4.jpg',
    ),
    AlbumModel(
      id: 'a3',
      title: 'Midnight Drive',
      artist: 'Synthwave',
      coverUrl: 'https://i.pinimg.com/1200x/06/df/af/06dfafefceb6dc9c122ceafcc733bf4b.jpg',
    ),
    AlbumModel(
      id: 'a4',
      title: 'Acoustic Soul',
      artist: 'Raw Sessions',
      coverUrl: 'https://i.pinimg.com/1200x/a1/43/25/a14325eed297bddcbf45dcd5ea2aa750.jpg',
    ),
  ];
  ...
  static const List<ArtistModel> trendingArtists = [
    ...
    ArtistModel(
      id: 'ar5',
      name: 'Charlie Puth',
      imageUrl: 'https://i.pinimg.com/736x/e6/32/d5/e632d5e486c14efde36c86bc54e89d59.jpg',
    ),
  ];
  ...
  static const List<PlaylistModel> yourPlaylists = [
    PlaylistModel(
      ...
      creator: 'You',
      coverUrl: 'https://i.pinimg.com/1200x/86/33/75/863375de702f6f28a2c4e70603ff7ba7.jpg',
    ),
    PlaylistModel(
      id: 'p2',
      title: 'Heartbreak Hits',
      creator: 'You',
      coverUrl: 'https://i.pinimg.com/736x/17/ef/ba/17efba17266b3b5bf6ab96b2415daa9b.jpg',
    ),
    PlaylistModel(
      id: 'p3',
      title: 'Khmer Music',
    ...
    PlaylistModel(
      ...
      title: 'Acoustic Pop',
      creator: 'Audify',
      coverUrl: 'https://i.pinimg.com/736x/15/56/72/1556725fd4f0784b7ebf8a7a8b3a0b6f.jpg',
    ),
  ];
  ...
  static const List<MixModel> madeForYou = [
    MixModel(
      ...
      coverUrl: 'https://i.pinimg.com/736x/2e/dd/00/2edd00dbb256d425cbb9a269b7899586.jpg',
    ...
    MixModel(
      ...
      coverUrl: 'https://i.pinimg.com/736x/22/13/9e/22139e119cbaf197138ac63325e5da1b.jpg',
    ...
    MixModel(
      ...
      coverUrl: 'https://i.pinimg.com/1200x/cd/36/b9/cd36b922115d150bd13ec1988f135091.jpg',
  ...
  static const List<GenreModel> browseGenres = [
    GenreModel(
      ...
      title: 'Pop',
      colorHex: '0xFFE13300',
      imageUrl: 'https://i.pinimg.com/1200x/d5/81/71/d58171e2b49edf5ac2c2f9ab36f11d9d.jpg',
    ),
    GenreModel(
      id: 'g2',
      title: 'Hip-Hop',
      colorHex: '0xFFBA5D07',
      imageUrl: 'https://i.pinimg.com/736x/52/5e/4e/525e4e1024fd9af6172ad9d42c06498e.jpg',
    ),
    GenreModel(
      id: 'g3',
      title: 'Khmer Music',
      colorHex: '0xFFFFFFFF',
      imageUrl: 'https://i.pinimg.com/736x/1b/27/25/1b2725a953afd02429bafc3bdbecd707.jpg',
    ),
    GenreModel(
      id: 'g4',
      title: 'Podcasts',
      colorHex: '0xFF27856A',
      imageUrl: 'https://i.pinimg.com/736x/ed/b0/72/edb072f1f8bde61ae3996cb05d8bf876.jpg',
    ),
    GenreModel(
      id: 'g5',
      title: 'Made For You',
      colorHex: '0xFF1E3264',
      imageUrl: 'https://i.pinimg.com/1200x/86/33/75/863375de702f6f28a2c4e70603ff7ba7.jpg',
    ),
    GenreModel(
      id: 'g6',
      title: 'New Releases',
      colorHex: '0xFFE8115B',
      imageUrl: 'https://i.pinimg.com/1200x/e3/c5/55/e3c55503141dfa4a0589939e90e8676a.jpg',
    ),
    GenreModel(
      id: 'g7',
      title: 'Charts',
      colorHex: '0xFF8D67AB',
      imageUrl: 'https://i.pinimg.com/736x/d2/fa/24/d2fa243e10fdd57fe416e168d3a457e9.jpg',
    ),
    GenreModel(
      id: 'g8',
      title: 'Live Events',
      colorHex: '0xFF7358FF',
      imageUrl: 'https://i.pinimg.com/736x/7b/ab/2d/7bab2d0f6e4eb929c4097b4b9935756a.jpg',
    ),
  ];
}
