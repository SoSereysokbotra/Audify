...
class ResetPasswordScreen extends StatefulWidget {
  ...
  const ResetPasswordScreen({Key? key, required this.resetCode})
    : super(key: key);
  @override
...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Icon(
            Icons.check,
            color: isMet ? AppColors.accent : AppColors.secondaryText,
            size: 16,
          ),
  ...
  Widget build(BuildContext context) {
    bool passwordsMatch =
        newPassword.isNotEmpty && confirmPassword == newPassword;
