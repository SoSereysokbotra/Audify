        ...
        child: CustomScrollView(
          ...
          slivers: [
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Icon(Icons.mic_none_rounded, color: Colors.grey[600], size: 24),
                              const SizedBox(width: 16),
                            ],
                          ),
                        ),
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 2,
                  childAspectRatio: 1.5, // Slightly adjusted for modern wide cards
                  crossAxisSpacing: 16,
                  mainAxisSpacing: 16,
                ),
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    return GenreCard(genre: MockData.browseGenres[index]);
                  },
            ...
            const SliverToBoxAdapter(
              child: SizedBox(height: 120), // Generous bottom padding for nav bars or mini players
            ),
          ],
        ),
      ),
  ...
  Widget _buildFilterChip(String label) {
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFF2A2A2A), // Adjust to match your AppColors theme
